...
#
# Usage:
# python slughorn_export.py <file.slug> [key] [output.png]
...
def run_selftest():
	...
	# --- Debug geometry ---
	save_curves_debug(view.curves, shape, "selftest_curves.png")
...
def main():
	...
	# --- Debug geometry ---
	save_curves_debug_svg(view.curves, shape, out_path + ".svg")
